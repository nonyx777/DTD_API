...
RSpec.describe "/drivers", type: :request do
  ...
  # DriversController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get drivers_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Driver" do
        expect {
          post drivers_url,
               params: { driver: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Driver" do
        expect {
          post drivers_url,
               params: { driver: invalid_attributes }, as: :json
        }.to change(Driver, :count).by(0)
      end

      it "renders a JSON response with errors for the new driver" do
        post drivers_url,
             params: { driver: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the driver" do
        driver = Driver.create! valid_attributes
        patch driver_url(driver),
              params: { driver: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe "DELETE /destroy" do
    it "destroys the requested driver" do
      driver = Driver.create! valid_attributes
      expect {
        delete driver_url(driver), headers: valid_headers, as: :json
      }.to change(Driver, :count).by(-1)
    end
  end
end
